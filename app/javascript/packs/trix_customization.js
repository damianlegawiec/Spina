                ...
                <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                      <input type="text" name="href" class="form-input block w-full sm:text-sm sm:leading-5" placeholder="${Trix.config.lang.urlPlaceholder}" aria-label="${Trix.config.lang.url}" required data-trix-input>
                    </div>
                  </div>
                </div>
