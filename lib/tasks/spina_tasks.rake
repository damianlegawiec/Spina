...
def enhance_assets_precompile
  ...
  deps = yarn_install_available? ? [] : ["spina:webpacker:yarn_install"]
  Rake::Task["assets:precompile"].enhance(deps) do
    Rake::Task["spina:webpacker:compile"].invoke
  end
end
...
unless skip_webpacker_precompile
  if Rake::Task.task_defined?("assets:precompile")
    ...
    Rake::Task.define_task("assets:precompile" => "spina:webpacker:compile")
  end
end
